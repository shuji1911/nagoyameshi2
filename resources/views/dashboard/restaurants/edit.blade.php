...
@section('content')                                                                                  
    ...
    <form method="POST" action="{{ route('dashboard.restaurants.update', $restaurant) }}" class="row" enctype="multipart/form-data">
        ...
        <div class="col-lg-7 form-group mb-3">
            ...
            <img src="{{ asset('storage/restaurants/'. $restaurant->image) }}" class="w-100" id="restaurantImagePreview"> 
        </div>                                               

        <div class="col-lg-7 form-group mb-3">
            <label for="description" class="col-md-5 col-form-label text-md-left fw-bold">説明</label>                    
            <textarea class="form-control" id="description" name="description" cols="30" rows="5" required>{{ old('description', $restaurant->description) }}</textarea>                                                
        </div> 
        ...
        <div class="col-lg-7 form-group mb-3">
            ...
            <div class="row g-1">
                <div class="col-auto"><span class="form-control-plaintext">〒</span></div>
                <div class="col-3">
                    <input type="number" class="form-control" id="postal_code1" name="postal_code1" value="{{ old('postal_code1', substr($restaurant->postal_code, 0, 3)) }}" required>
                </div>
                <div class="col-auto"><span class="form-control-plaintext">-</span></div>
                <div class="col-4">
                    <input type="number" class="form-control" id="postal_code2" name="postal_code2" value="{{ old('postal_code2', substr($restaurant->postal_code, 3)) }}" required>
                </div>
            </div>
        </div>
