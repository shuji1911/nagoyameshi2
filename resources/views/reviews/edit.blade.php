            ...
            <div class="col-xxl-6 col-xl-7 col-lg-8 col-md-10">                
                ...
                <form method="POST" action="{{ route('restaurants.reviews.update', [$restaurant, $review]) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div>
                            <textarea class="form-control" id="comment" name="comment" cols="30" rows="5">{{ old('comment', $review->comment) }}</textarea>                            
                        </div>
                    </div>                                                             

                    <div class="form-group mb-4">
                        <button type="submit" class="btn btn-primary shadow-sm">編集</button>
                    </div>
                </form>                
            </div>                          
        </div>
